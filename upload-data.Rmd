...
myAccessRules <- data.frame(subject=c("https://orcid.org/0000-0002-1642-628X", "https://orcid.org/0000-0002-9088-5767"), permission="changePermission") 
...
```{r, eval=FALSE}
packageId <- uploadDataPackage(d1c, dp, public=FALSE, accessRules=myAccessRules, quiet=FALSE)
```
